...
bool Socket::connect(const string &ip, int port)
{
    ...
    {
        printf("socket connect error: errno=%d errstr=%s", errno, strerror(errno));
        return false;
    }
    return true;
}
...
int Socket::accept()
{
	...
	if (sockfd < 0)
	{
        printf("accept call error: errno=%d errstr=%s", errno, strerror(errno));
        sockfd = -1;
	}
	return sockfd;
}
...
bool Socket::set_non_blocking()
{
    ...
    if (flags < 0)
    {
        printf("Socket::set_non_blocking(F_GETFL, O_NONBLOCK): errno=%d errstr=%s", errno, strerror(errno));
        return false;
    }
    flags |= O_NONBLOCK;
    if (fcntl(m_sockfd, F_SETFL, flags) < 0)
    {
        printf("Socket::set_non_blocking(F_SETFL, O_NONBLOCK): errno=%d errstr=%s", errno, strerror(errno));
        return false;
    }
    return true;
}
...
bool Socket::set_send_buffer(int size)
{
    ...
    {
        printf("socket set send buffer error: errno=%d errstr=%s", errno, strerror(errno));
        return false;
    }
    return true;
}
...
bool Socket::set_recv_buffer(int size)
{
    ...
    {
        printf("socket set recv buffer error: errno=%d errstr=%s", errno, strerror(errno));
        return false;
    }
    return true;
}
...
bool Socket::set_linger(bool active, int seconds)
{
    ...
    {
        printf("socket set sock linger error: errno=%d errstr=%s", errno, strerror(errno));
        return false;
    }
    return true;
}
...
bool Socket::set_keep_alive()
{
    ...
    {
        printf("socket set sock keep alive error: errno=%d errstr=%s", errno, strerror(errno));
        return false;
    }
    return true;
}
...
bool Socket::set_reuse_addr()
{
    ...
    {
        printf("socket set sock reuser addr error: errno=%s errstr=%s", errno, strerror(errno));
        return false;
    }
    return true;
}
...
bool Socket::set_reuse_port()
{
    ...
    {
        printf("socket set sock reuser port error: errno=%d errstr=%s", errno, strerror(errno));
        return false;
    }
    return true;
}
